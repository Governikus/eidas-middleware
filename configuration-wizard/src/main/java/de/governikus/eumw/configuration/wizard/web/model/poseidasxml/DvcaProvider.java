 ...
 */
@Slf4j
public enum DvcaProvider
{
  GOV_DVCA("govDvca"), BUDRU("budru"), NEW_GOV_DVCA("newGovDvca");
   ...
   */
  public static Optional<DvcaProvider> fromValue(String value)
  {
    for ( DvcaProvider dvcaProvider : values() )
    {
      if (StringUtils.equals(dvcaProvider.getValue(), value)
          || StringUtils.equals(dvcaProvider.name(), value))
      {
        return Optional.of(dvcaProvider);
      }
    }
