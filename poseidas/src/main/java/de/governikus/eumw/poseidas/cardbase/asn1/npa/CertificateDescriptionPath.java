...
public class CertificateDescriptionPath extends ASN1Path
{
   ...
   */
  private static final CertificateDescriptionPath TERMS_OF_USAGE = new CertificateDescriptionPath("TERMS_OF_USAGE",
                                                                                                  "a5", 0,
                                                                                                  CERTIFICATE_DESCRIPTION);
   ...
   */
  static final CertificateDescriptionPath COMM_CERTIFICATES_PART = new CertificateDescriptionPath("COMM_CERTIFICATES_PART",
                                                                                                  "a7", 0,
                                                                                                  CERTIFICATE_DESCRIPTION);
   ...
   */
  public static final CertificateDescriptionPath COMM_CERTIFICATES = new CertificateDescriptionPath("COMM_CERTIFICATES",
                                                                                                    "31", 0,
