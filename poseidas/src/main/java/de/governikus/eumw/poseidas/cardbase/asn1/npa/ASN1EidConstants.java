...
public final class ASN1EidConstants
{
   ...
   */
  static final ImmutableByteArray TAG_CERTIFICATE_EXPIRATION_DATE = ImmutableByteArray.of(new byte[]{0x5f,
                                                                                                     0x24});

  /**
   * Tag for certificate effective date: <code>0x5f25</code>.
   */
  static final ImmutableByteArray TAG_CERTIFICATE_EFFECTIVE_DATE = ImmutableByteArray.of(new byte[]{0x5f,
                                                                                                    0x25});

  /**
   * Tag for certificate profile identifier: <code>0x5f29</code>.
   */
  static final ImmutableByteArray TAG_CERTIFICATE_PROFILE_IDENTIFIER = ImmutableByteArray.of(new byte[]{0x5f,
                                                                                                        0x29});
