...
public class ReadAttributeResult extends AbstractResult<List<byte[]>> implements FunctionResult<List<byte[]>>
{

  ReadAttributeResult(Throwable throwable)
  {
    super(throwable);
  }

  ReadAttributeResult(List<byte[]> data)
  {
    super(data);
  }
}
