...
public class CertificateRequestPath extends ASN1Path
{
   ...
   * @param filter filter for element
   * @param parent optional parent path element
   * @see ASN1Path#ASN1Path(String, BigInteger, int, ASN1Path, Class)
   * @see HexUtil#parseBigInteger(String)
   */
  private CertificateRequestPath(String name, byte tagByte, Filter<ASN1> filter, CertificateRequestPath parent)
  {
    super(name, tagByte, filter, parent, null);
  }

  /**
   * Path to root of certificate request - authentication - see table D.1 at TC-03110, version 2.02.
   */
  static final CertificateRequestPath AUTHENTICATION = new CertificateRequestPath(
                                                                                         "CERTIFICATE_REQUEST",
                                                                                         "67", 0, null);
   ...
   */
  static final CertificateRequestPath CV_CERTIFICATE = new CertificateRequestPath(
                                                                                         "CV_CERTIFICATE",
   ...
   */
  public static final CertificateRequestPath CV_CERTIFICATE_BODY = new CertificateRequestPath(
                                                                                              "CV_CERTIFICATE_BODY",
   ...
   */
  static final CertificateRequestPath CA_REFERENCE = new CertificateRequestPath(
                                                                                       "CA_REFERENCE",
   ...
   */
  public static final CertificateRequestPath HOLDER_REFERENCE = new CertificateRequestPath(
                                                                                           "HOLDER_REFERENCE",
   ...
   */
  public static final CertificateRequestPath PUBLIC_KEY = new CertificateRequestPath(
                                                                                     "PUBLIC_KEY",
   ...
   */
  static final CertificateRequestPath SIGNATURE = new CertificateRequestPath(
                                                                                    "SIGNATURE",
   ...
   */
  static final CertificateRequestPath CERTIFICATE_EXTENSIONS = new CertificateRequestPath(
                                                                                                 "BODY_CERTIFICATE_EXTENSIONS",
   ...
   * extensions.
   */
  static final CertificateRequestPath EXTENSIONS_DISCRETIONARY_DATA_FIRST = new CertificateRequestPath(
   ...
   */
  static final CertificateRequestPath DISCRETIONARY_DATA_FIRST_OID = new CertificateRequestPath(
                                                                                                       "DISCRETIONARY_DATA_FIRST_OID",
   ...
   */
  static final CertificateRequestPath DISCRETIONARY_DATA_FIRST_HASH = new CertificateRequestPath(
                                                                                                        "DISCRETIONARY_DATA_FIRST_HASH",
                                                                                                        "80",
                                                                                                        0,
                                                                                                        EXTENSIONS_DISCRETIONARY_DATA_FIRST);
   ...
   * extensions.
   */
  static final CertificateRequestPath EXTENSIONS_DISCRETIONARY_DATA_SECOND = new CertificateRequestPath(
   ...
   */
  static final CertificateRequestPath DISCRETIONARY_DATA_SECOND_OID = new CertificateRequestPath(
                                                                                                        "DISCRETIONARY_DATA_SECOND_OID",
                                                                                                        ASN1Constants.UNIVERSAL_TAG_OID,
                                                                                                        0,
                                                                                                        EXTENSIONS_DISCRETIONARY_DATA_SECOND,
                                                                                                        OID.class);
   ...
   */
  static final CertificateRequestPath DISCRETIONARY_DATA_SECOND_HASH = new CertificateRequestPath(
                                                                                                         "DISCRETIONARY_DATA_SECOND_HASH",
                                                                                                         "80",
                                                                                                         0,
                                                                                                         EXTENSIONS_DISCRETIONARY_DATA_SECOND);
   ...
   */
  static final CertificateRequestPath OUTER_CA_REFERENCE = new CertificateRequestPath(
                                                                                             "OUTER_CA_REFERENCE",
                                                                                             ASN1EidConstants.TAG_CERTIFICATION_AUTHORITY_REFERENCE,
                                                                                             0,
                                                                                             AUTHENTICATION);
   ...
   */
  static final CertificateRequestPath OUTER_SIGNATURE = new CertificateRequestPath(
                                                                                          "OUTER_SIGNATURE",
                                                                                   ASN1EidConstants.TAG_SIGNATURE.toArray(),
                                                                                          0, AUTHENTICATION);
