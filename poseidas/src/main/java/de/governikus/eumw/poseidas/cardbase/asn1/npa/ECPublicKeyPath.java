...
public final class ECPublicKeyPath extends ASN1Path
{
  ...
  static final ECPublicKeyPath EC_PUBLIC_KEY = new ECPublicKeyPath("PUBLIC_KEY",
                                                                   ASN1EidConstants.TAG_PUBLIC_KEY.toArray(), 0, null);

  /**
   * Path to OID of public key.
   */
  static final ECPublicKeyPath OID = new ECPublicKeyPath("OID", ASN1Constants.UNIVERSAL_TAG_OID, 0, EC_PUBLIC_KEY,
                                                         OID.class);

  /**
   * Path to prime modulus (curve parameter) of public key.
   */
  public static final ECPublicKeyPath PRIME_MODULUS = new ECPublicKeyPath("PRIME_MODULUS", "81", 0, EC_PUBLIC_KEY);

  /**
   * Path to coefficient A (curve parameter) of public key.
   */
  public static final ECPublicKeyPath COEFFICIENT_A = new ECPublicKeyPath("COEFFICIENT_A", "82", 0, EC_PUBLIC_KEY);

  /**
   * Path to coefficient B (curve parameter) of public key.
   */
  public static final ECPublicKeyPath COEFFICIENT_B = new ECPublicKeyPath("COEFFICIENT_B", "83", 0, EC_PUBLIC_KEY);

  /**
   * Path to base point G (curve parameter) of public key.
   */
  public static final ECPublicKeyPath BASE_POINT_G = new ECPublicKeyPath("BASE_POINT_G", "84", 0, EC_PUBLIC_KEY);

  /**
   * Path to order of base point R (curve parameter) of public key.
   */
  public static final ECPublicKeyPath ORDER_OF_BASE_POINT_R = new ECPublicKeyPath("ORDER_OF_BASE_POINT_R", "85", 0,
                                                                                  EC_PUBLIC_KEY);

  /**
   * Path to public key point (represents public key of owner) of public key.
   */
  public static final ECPublicKeyPath PUBLIC_POINT_Y = new ECPublicKeyPath("PUBLIC_POINT_Y", "86", 0, EC_PUBLIC_KEY);
