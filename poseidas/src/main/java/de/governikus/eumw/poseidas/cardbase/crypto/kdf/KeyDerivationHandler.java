...
public interface KeyDerivationHandler
{
   ...
   */
  public abstract SecretKey deriveCANPINPUKKey(byte[] data)
   ...
   * @throws NoSuchProviderException
   */
  public abstract SecretKey deriveEncKey(byte[] data, byte[] nonce)
    throws InvalidKeyException, InvalidKeySpecException, NoSuchAlgorithmException, NoSuchProviderException;
   ...
   * @throws NoSuchProviderException
   */
  public abstract SecretKey deriveMACKey(byte[] data, byte[] nonce)
    throws InvalidKeyException, InvalidKeySpecException, NoSuchAlgorithmException, NoSuchProviderException;
}
