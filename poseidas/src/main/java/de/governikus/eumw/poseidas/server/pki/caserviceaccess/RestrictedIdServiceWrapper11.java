 ...
 */
public class RestrictedIdServiceWrapper11 extends RestrictedIdServiceWrapper
{
   ...
   */
  RestrictedIdServiceWrapper11(PKIServiceConnector con, String uri) throws URISyntaxException
  {
