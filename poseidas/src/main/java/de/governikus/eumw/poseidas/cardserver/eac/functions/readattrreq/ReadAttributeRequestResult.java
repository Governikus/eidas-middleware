...
public class ReadAttributeRequestResult extends AbstractResult<byte[]> implements FunctionResult<byte[]>
{

  ReadAttributeRequestResult(Throwable throwable)
  {
    super(throwable);
  }

  ReadAttributeRequestResult(byte[] data)
  {
    super(data);
  }
}
