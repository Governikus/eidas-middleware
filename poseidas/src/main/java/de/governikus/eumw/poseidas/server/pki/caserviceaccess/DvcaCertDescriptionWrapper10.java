 ...
 * @author mehrtens
 */
public class DvcaCertDescriptionWrapper10 implements DvcaCertDescriptionWrapper
{
   ...
   */
  DvcaCertDescriptionWrapper10(PKIServiceConnector con, String uri) throws URISyntaxException
  {
	  DVCACertDescriptionService service = new DVCACertDescriptionService();
