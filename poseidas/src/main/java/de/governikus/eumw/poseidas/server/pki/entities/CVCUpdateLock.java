...
public class CVCUpdateLock implements Serializable
{
   ...
   * @param lockedAt
   */
  public CVCUpdateLock(String serviceProvider, long lockedAt)
  {
  ...
  /**
   * Return the creation time of this lock in milliseconds. Not that container transaction cannot be used for removing
   * out-dated locks because lock must be propagated before update transaction starts
   */
