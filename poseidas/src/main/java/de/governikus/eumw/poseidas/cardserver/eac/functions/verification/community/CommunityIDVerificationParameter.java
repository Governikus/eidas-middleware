...
/**
 * Implementation of CommunityIDVerification input parameter.
 * 
 * @see CommunityIDVerification
 * @see Connector#execute(Parameter)
 * @see CommunityVerificationResult
 * @author Jens Wothe, jw@bos-bremen.de
 */
public class CommunityIDVerificationParameter implements FunctionParameter
{}
