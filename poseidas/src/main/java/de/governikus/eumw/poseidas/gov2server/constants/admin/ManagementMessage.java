...
/**
 * Represents a (usually error-) message which can be displayed on the administration console. Objects of this class
 * consist of a code which must be understood by the administration console and possibly one or more details Strings
 * depending on the respective code.
 *
 * @author tt
 */
