...
/**
 * Supports creation of key pairs suitable for CVCs. Note: such a key pair differs from those used only as ephemeral
 * keys, e.g. by the private key being stored in the HSM.
 *
