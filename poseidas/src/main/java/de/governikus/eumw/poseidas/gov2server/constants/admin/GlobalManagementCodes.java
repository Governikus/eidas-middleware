...
/**
 * This is the set of all error codes which may produced by the management of several Governikus modules. The WebAdmin
 * should be able to display a nice text for each messages created by one of these codes.
 * <p>
...
public final class GlobalManagementCodes
{
  ...
  /**
   * A value in the configuration is invalid and does not permit the current operation. Detail is the name of the
  ...
  /**
   * A value in the configuration is missing - add it and save the configuration. Detail is the name of the respective
   * configuration attribute.
   */
  public static final Code1 EC_MISSINGCONFIGVALUE = new Code1(PREFIX_ERROR + "missingConfigvalue");

  /**
   * An unexpected error has occurred. Try to use more specific messages instead of this one. parameter explaining
   * message
   */
