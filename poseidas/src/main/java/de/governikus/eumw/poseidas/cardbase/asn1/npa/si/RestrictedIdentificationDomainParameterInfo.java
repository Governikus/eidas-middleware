...
/**
 * Implementation of the <code>RestrictedIdentificationDomainParameterInfo</code> structure in {@link SecurityInfos}.
 *
...
public class RestrictedIdentificationDomainParameterInfo extends DomainParameterInfo
{
   ...
   * Constructor.
   *
   * @param bytes byte-array containing ASN.1 description of a {@link RestrictedIdentificationDomainParameterInfo}
