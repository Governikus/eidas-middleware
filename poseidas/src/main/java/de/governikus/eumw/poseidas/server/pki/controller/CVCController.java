...
/**
 * This controller provides the different routes for listing the entities and
 * viewing the details page for a single entity.
 * 
 * @author bpr
 *
 */
...
public class CVCController {
	...
	/**
	 * On startup, create a hashmap containing the entityID and the corresponding
	 * {@link CVCInfoBean} object
	 * 
	 * @param data
	 *            the reference to the {@link PermissionDataHandling}
	 */
	...
	public void index(HttpServletResponse response) throws IOException {
		response.sendRedirect(appContext.getApplicationName() + "/list");
	}
