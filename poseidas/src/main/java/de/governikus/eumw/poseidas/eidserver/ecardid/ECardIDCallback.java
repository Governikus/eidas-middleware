...
public interface ECardIDCallback extends Serializable
{
  ...
  /**
   * This method is called when the PAOS receiver gets a call with an unknown session id. This method should return the
   * SessionInput for this session ID if this session is known or null if it is unknown.
   *
  ...
  /**
   * This method is called when the Session is completed and the session result is provided to the original initiator of
   * this session.
   *
