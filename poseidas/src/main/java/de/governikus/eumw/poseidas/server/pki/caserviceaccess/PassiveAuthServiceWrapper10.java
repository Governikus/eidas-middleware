...
import uri.eac_pki_is_protocol._1_0.passiveAuth.dv.EACDVProtocolService;
import uri.eac_pki_is_protocol._1_0.passiveAuth.dv.EACPKIDVProtocolType;
import uri.eacbt._1_0.passiveAuth.dv.CallbackIndicatorType;
import uri.eacbt._1_0.passiveAuth.dv.GetDefectListResult;
import uri.eacbt._1_0.passiveAuth.dv.GetDefectListReturnCodeType;
import uri.eacbt._1_0.passiveAuth.dv.GetMasterListResult;
import uri.eacbt._1_0.passiveAuth.dv.GetMasterListReturnCodeType;
import uri.eacbt._1_0.passiveAuth.dv.OptionalMessageIDType;
import uri.eacbt._1_0.passiveAuth.dv.OptionalStringType;


/**
 * Class to abstract from the actual service class, mainly to keep the imports in. Remember that all the CA
 * services have the same name.
 *
 * @author tautenhahn
 */
class PassiveAuthServiceWrapper10 implements PassiveAuthServiceWrapper
{
  ...
  public PassiveAuthServiceWrapper10(PKIServiceConnector con, String uri) throws URISyntaxException
  {
  ...
  public byte[] getDefectList()
  {
    ...
    {
      SNMPDelegate.getInstance().sendSNMPTrap(OID.DEFECTLIST_RENEWAL_FAILED,
                                              SNMPDelegate.DEFECTLIST_RENEWAL_FAILED + " "
                                                + mResult.getReturnCode().value());
      return null;
    }
