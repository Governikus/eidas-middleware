...
/**
 * ResultMinor This Enumeration contains all possible error Codes that are mentioned the eCard-API. Each specified
 * another source of a message.
 * <p>
 * Look for further information in OASIS DSS oasis-dss-core-spec-v1.0-os.pdf
 * </p>
 * Auto generated Java file - please do not edit (Bitte nicht editieren) Was build on Fri Mar 20 16:34:57 CET 2015 by
 * hauke
 *
 * @author XSD2Java
 */
public enum ResultMinor
{
  ...
  /**
   * CardInfo-File existiert nicht URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/al/CardInfo#notExisting
   */
  ...
  /**
   * Fehlerhaftes CardInfo-File URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/al/CardInfo#incorrectFile
   */
  CARD_INFO_INCORRECT_FILE("http://www.bsi.bund.de/ecard/api/1.1/resultminor/al/CardInfo#incorrectFile"),
  /**
   * No qualified certificate found. So the overall result of the verification interpreter is undetermined URI value:
   * http://www.bos-bremen.de/ecard/api/1.0/resultminor/vii/vii#not_qualified_certificate
   */
  ...
  /**
   * Die Antwort des Verifikationsservers wurde verändert. Oder es ist ein falsches Server-Zertifikat konfiguriert. URI
   * value: http://www.bos-bremen.de/ecard/api/1.0/resultminor/vr/vr#server_signature_invalid
   */
  ...
  /**
   * Der Zustand des Zertifikats konnte nicht ermittelt werden, da die Online-Prüfung ausgeschaltet ist. URI value:
   * http://www.bos-bremen.de/ecard/api/1.0/resultminor/vr/vr#cert_no_online_verify
   */
  VR_CERT_NO_ONLINE_VERIFY("http://www.bos-bremen.de/ecard/api/1.0/resultminor/vr/vr#cert_no_online_verify"),
  /**
   * Bei der Verifikation wurde kein Signaturzeitpunkt gefunden. Da man so nicht sagen kann, ob das Zertifikat zum
   * Signaturzeitpunkt gültig war, gibt es kein bestimmtes Prüfergebnis. URI value:
  ...
  /**
   * There was some unknown error An unexpected error has occurred during processing which cannot be represented by the
   * standard codes or specific service error codes. The error and detail texts can describe the error more closely.
   * (API_UNKNOWN_ERROR) URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/al/common#unknownError
   */
   ...
   * Standardfehlercodes bzw. auf die dienstspezifischen Fehlercodes abgebildet werden kann. Der Fehler- und der
   * Detailtext können den Fehler näher beschreiben. (API_UNKNOWN_ERROR) URI value:
  ...
  /**
   * Parameter Fehler Falscher, fehlender oder nicht dem Format entsprechender Parameter. (API_INCORRECT_PARAMETER) This
   * was removed in TR-03112 version 1.1.5 Deprecated: use common_incorrectParameter URI value:
  ...
  /**
   * Parameter Fehler Falscher, fehlender oder nicht dem Format entsprechender Parameter. (API_INCORRECT_PARAMETER) This
   * was added in TR-03112 version 1.1.5 URI value:
  ...
  /**
   * API-Funktion unbekannt URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/al/common#unknownAPIFunction
   */
  COMMON_UNKNOWN_API_FUNCTION("http://www.bsi.bund.de/ecard/api/1.1/resultminor/al/common#unknownAPIFunction"),
  /**
   * Framework nicht initialisiert URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/al/common#notInitialized
   */
  ...
  /**
   * Unbekanntes Modulbt URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/al/FrameworkUpdate#unknownModule
   */
  ...
  /**
   * Kartenterminal existiert bereits URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/al/IFD#addNotPossible
   */
  ...
  /**
   * Ungültige TrustedViewerId URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/al/TrustedViewer#invalidID
   */
  ...
  /**
   * TSL kann nicht entfernt werden URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/al/TSL#exportNotPossible
   */
  TSL_EXPORT_NOT_POSSIBLE("http://www.bsi.bund.de/ecard/api/1.1/resultminor/al/TSL#exportNotPossible"),
  /**
   * TSL kann nicht exportiert werden URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/al/TSL#unknownTSL
   */
  TSL_UNKNOWN_TSL("http://www.bsi.bund.de/ecard/api/1.1/resultminor/al/TSL#unknownTSL"),
  /**
   * Der Knoten ist nicht erreichbar. URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/dp#nodeNotReachable
   */
  DP_NODE_NOT_REACHABLE("http://www.bsi.bund.de/ecard/api/1.1/resultminor/dp#nodeNotReachable"),
  /**
   * Zeitüberschreitung (Timeout) Die Operation wurde wegen Zeitüberschreitung abgebrochen. Deprecated: This is not
   * defined in TR-03112 URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/dp/dp#timeout
   */
  @Deprecated
  ...
  /**
   * Signaturformat nicht unterstützt Das angegebene Signatur- oder Zeitstempel-Format wird nicht unterstützt. URI
   * value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/il/signature#signatureFormatNotSupported
   */
  ...
  /**
   * IncludeEContent nicht möglich Diese Warnung wird zurückgeliefert, wenn das IncludeEContent-Flag bei der Erzeugung
   * einer PDF-Signatur, eines Zeitstempels oder bei der übergabe eines Hashwertes zur Erzeugung einer Signatur gesetzt
   * wird. URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/il/signature#unableToIncludeEContentWarning
   */
  ...
  /**
   * ignoredSignaturePlacementFlagWarning SignaturePlacement-Flag wurde ignoriert Diese Warnung wird zurückgeliefert,
   * wenn das SignaturePlacement-Flag bei einer Nicht-XML-basierten Signatur gesetzt wurde. URI value:
  ...
  /**
   * Zertifikat ist nicht verfügbar Das angegebene Zertifikat steht der Funktion nicht zur Verfügung. Die Ursache könnte
   * eine falscher Verweis oder ein gelöschtes Datenfeld sein. URI value:
  ...
  /**
   * Zertifikat kann nicht interpretiert werden Das Format des angegebenen Zertifikates ist unbekannt und kann nicht
   * interpretiert werden. URI value:
  ...
  /**
   * Das Zertifikat wurde nicht ausreichend überprüft. Zum Beispiel weil es nicht geht, weil es zum Beispiel nicht
   * qualifiziert ist. Das ist eine Warnung, die bedeutet das das Verifikationsergebniss mit vorsicht zu geniessen ist.
   * URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/il/signature#certificateStatusNotCheckedWarning
   */
  ...
  /**
   * Zertifikatskette ist unterbrochen Die angegebene Zertifikatskette ist unterbrochen. Somit kann eine vollständige
   * Prüfung bis zum Root-Zertifikat nicht erfolgen. URI value:
  ...
  /**
   * Transformationsalgorithmn not supported. The sign request contained a transformation that can not be supported by
   * the eCard-API. URI value:
   ...
   * http://www.bsi.bund.de/ecard/api/1.1/resultminor/il/signature#suiteabilityOfAlgorithmsNotCheckedWarning URI value:
  ...
  /**
   * Signaturformat fehlerhaft Das Format der übergebenen Signatur entspricht nicht der vorgesehenen Spezifikation.
   * Dieser Fehler tritt auf, wenn zwar ein unterstütztes Format (z.B. gemäß [RFC3275] oder [RFC3369]) erkannt wurde,
   * die Signatur aber nicht der vorgesehenen Form genügt. Wird bereits das übergebene Format nicht erkannt, so wird
   * Fehler 2801 zurück geliefert. URI value:
  ...
  /**
   * Zertifikat gesperrt URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/il/signature#certificateRevoked
   */
  ...
  /**
   * IncludeObject nur bei XML-Signaturen erlaubt URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/il
  ...
  /**
   * Signature Policy unknown. ACHTUNG: Dieser Code wird zwar in der Dokumentation zum Sign Request erklärt teil2.pdf,
   * fehlt aber in der Liste der Fehlermeldungen im Teil1.pdf. URI value:
  ...
  /**
   * Abbruch durch den Nutzer URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/il/viewer#cancelationByUser
   */
  ...
  /**
   * ViewerMessage zu lang URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/il/viewer#viewerMessageTooLong
   */
  VIEWER_VIEWER_MESSAGE_TOO_LONG("http://www.bsi.bund.de/ecard/api/1.1/resultminor/il/viewer#viewerMessageTooLong"),
  /**
   * Codierung nicht möglich URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal/support#encodingError
   */
  SUPPORT_ENCODING_ERROR("http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal/support#encodingError"),
  /**
   * Decodierung nicht möglich URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal/support#decodingError
   */
  ...
  /**
   * Zeitüberschreitung (Timeout) Die Operation wurde wegen Zeitüberschreitung abgebrochen. (API_TIMEOUT_ERROR)
   * Deprecated: This is not defined in TR-03112 URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal#timeout
   */
  @Deprecated
   ...
   * Signaturerzeugung im Trusted Viewer) wurde durch Abbruch beendet (API_CANCELLATION_BY_USER) Deprecated: This is
   * spelled wrong URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal#cancelationByUser
   */
  @Deprecated
   ...
   * documented in part 1 of ecard-API1.1, it is in part 6 but there it is spelled cancellation, mind the double-l. But
   * there it is not documented for the DIDAuthenticate API-call. Deprecated: This is not defined in TR-03112 URI value:
   * http://www.bsi.bund.de/ecard/api/1.1/resultminor/ifdl#cancelationByUser
   */
  @Deprecated
  IFDL_CANCELATION_BY_USER("http://www.bsi.bund.de/ecard/api/1.1/resultminor/ifdl#cancelationByUser"),
  /**
   * This is the ResultMinor the BuergerClient Testversion 4 sends when in an ordinary desktop dialog "Abbrechen" is
   * pushed. This is not documented for the DIDAuthenticate API-call. See ECA-495 URI value:
  ...
  /**
   * Name existiert bereits (API_NAME_EXISTS) URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal#nameExists
   */
  ...
  /**
   * Mathematische Prüfung der digitalen Signatur schlug fehl Deprecated: This is not specified in TR-03112 Version
   * 1.1.5 URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal#digitalSignatureNotCorrect
   */
  @Deprecated
  ...
  /**
   * Entschlüsselung nicht möglich URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal#decryptionNotPossible
   */
  ...
  /**
   * Keine Initialisierung erfolgt Die verwendete Operation benötigt eine Initialisierung (API_NOT_INITIALIZED) URI
   * value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal#notInitialized
   */
  ...
  /**
   * Warnung - Verbindung wurde getrennt (API_WARNING_CONNECTION_DISCONNECTED) Deprecated: This is not defined in
   * TR-03112 URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal#connectionDisconnectedWarning
   */
  @Deprecated
   ...
   * (API_NAMED_ENTITY_NOT_FOUND) URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal#namedEntityNotFound
   */
  ...
  /**
   * Kein Platz verfügbar Unter der angegebenen Referenz ist kein Speicherplatz verfügbar. Deprecated: This is not
   * defined in TR-03112 URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal#noSpaceAvailable
   */
  @Deprecated
  ...
  /**
   * Identifikationsdaten fehlerhaft (x verbleibende Versuche) (EOP_RC) Deprecated: This is not specified by the BSI, do
   * not use it. URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal#wrongReferenceData
   */
  @Deprecated
  ...
  /**
   * Identifikationsdaten blockiert (REFERENCE DATA BLOCKED) Deprecated: This is not defined in TR-03112 URI value:
   * http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal#referenceDataBlocked
   */
  @Deprecated
  SAL_REFERENCE_DATA_BLOCKED("http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal#referenceDataBlocked"),
  /**
   * Authentisierungsfunktion nicht freigeschaltet Die Authentisierungsfunktion kann noch nicht genutzt werden, weil
   * beispielsweise die Applikation noch nicht vollständig ist. Das kann bei einer SigG-Anwendung ein fehlender
   * Schlüssel oder ein noch nicht freigeschaltetes Zertifikat sein. Deprecated: This is not defined in TR-03112 URI
   * value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal#authenticationNotActivated
   */
  @Deprecated
   ...
   * Identifikationsdaten kann nicht durchgeführt werden, weil sie nicht die notwendigen Anforderungen erfüllt;
   * beispielsweise muss eine Transport-PIN erst geändert werden. (Condition OF USE) Deprecated: This is not defined in
   * TR-03112 URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal#conditionOfUseNotSatisfied
   */
  @Deprecated
  SAL_CONDITION_OF_USE_NOT_SATISFIED("http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal#conditionOfUseNotSatisfied"),
  /**
   * Funktion nicht unterstützt (FUNCTION NOT SUPPORTED) Deprecated: This is not defined in TR-03112 URI value:
   * http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal#functionNotSupported
   */
  @Deprecated
  SAL_FUNCTION_NOT_SUPPORTED("http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal#functionNotSupported"),
  /**
   * Funktionalität wird von der aktuellen Version der API nicht unterstützt. Deprecated: This is not defined in
   * TR-03112 URI value:
  ...
  /**
   * Angegebene Daten oder Referenzdaten nicht gefunden (DATA NOT FOUND) Deprecated: This is not defined in TR-03112 URI
   * value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal#dataNotFound
   */
  @Deprecated
  ...
  /**
   * Zertifikat kann nicht interpretiert werden. Das Format des angegebenen Zertifikates ist unbekannt und kann nicht
   * interpretiert werden. Deprecated: This is not defined in TR-03112 URI value:
  ...
  /**
   * The mandatory document validity check has failed. From the draft of part 7 from 20100922, special Minor code for
   * document validity failed. URI value:
  ...
  /**
   * If the community affiliation process fails, a warning is returned in the CommunityVerification element. URI value:
  ...
  /**
   * In the case of a remote terminal any password transmitted in this element is ignored and this warning is returned.
   * URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal/PACE#PasswordIgnoredWarning
   */
  SAL_PACE_PASSWORD_IGNORED_WARNING("http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal/PACE#PasswordIgnoredWarning"),
  /**
   * If the ReturnEFCardAccess is set true in PACEDIDAuthenticateInputType but no EF.CardAccess file is available on the
   * card, this warning is returned. URI value:
  ...
  /**
   * See CADIDUpdateDataType in part 7 for more information. If the generateFlag alternative is selected in the KeyInfo
   * element and if the CAPublicKey element is also contained in the Marker, a warning is returned. URI value:
  ...
  /**
   * Zeitüberschreitung (Timeout) Die Operation wurde wegen Zeitüberschreitung abgebrochen. (API_TIMEOUT_ERROR) URI
   * value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/ifdl/common#timeoutError
   */
  IFDL_COMMON_TIMEOUT_ERROR("http://www.bsi.bund.de/ecard/api/1.1/resultminor/ifdl/common#timeoutError"),
  /**
   * Unbekanntes Context Handle (IFD_INVALID_CONTEXT_HANDLE) Deprecated: This is not defined in TR-03112 URI value:
   * http://www.bsi.bund.de/ecard/api/1.1/resultminor/ifdl/common#unknownContextHandle
   */
  @Deprecated
  ...
  /**
   * Abbruch des Kommandos nicht möglich (IFD_CANCEL_NOT_POSSIBLE) Deprecated: This is not defined in TR-03112 URI
   * value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/ifdl/IO#cancelationNotPossibleWarning
   */
  @Deprecated
  IO_CANCELATION_NOT_POSSIBLE_WARNING("http://www.bsi.bund.de/ecard/api/1.1/resultminor/ifdl/IO#cancelationNotPossibleWarning"),
  /**
   * Keine Chipkartentransaktion gestartet (IFD_NO_TRANSACTION_STARTED) Deprecated: This is not defined in TR-03112 URI
   * value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/ifdl/IO#noTransactionStartedWarning
   */
  @Deprecated
  ...
  /**
   * Erneut erfasste Identifikationsdaten stimmen nicht überein (IFD_REPEATED_DATA_MISMATCH) Deprecated: This is not
  ...
  /**
   * Exklusive Reservierung nicht möglich Die exklusive Reservierung der eCard ist nicht möglich. Mögliche Ursachen
   * sind, dass weitere Anwendungen auf die eCard zugreifen oder die Rechte für die exklusive Reservierung der eCard
   * nicht vorhanden sind (API_EXCLUSIVE_NOT_AVAILABLE) Deprecated: This is not defined in TR-03112 URI value:
   ...
   * Exklusive Reservierung nicht möglich Die exklusive Reservierung der eCard ist nicht möglich. Mögliche Ursachen
   * sind, dass weitere Anwendungen auf die eCard zugreifen oder die Rechte für die exklusive Reservierung der eCard
   * nicht vorhanden sind (API_EXCLUSIVE_NOT_AVAILABLE) Deprecated: This is not avaliable in TR-03112 version 1.1.5 any
   * more URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/sal#exclusiveNotAvailable
   */
  @Deprecated
  ...
  /**
   * Kartenterminal existiert nicht Das adressierte Kartenterminal (IFD) ist unbekannt. (IFD_UNKNOWN_IFD) URI value:
   * http://www.bsi.bund.de/ecard/api/1.1/resultminor/ifdl/terminal#unknownIFD
   */
  ...
  /**
   * The request was not successful, because the card is already used by another process (IFD_SHARING_VIOLATION)) URI
   * value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/ifdl/terminal#IFDSharingVolation
   */
  TERMINAL_IFD_SHARING_VOLATION("http://www.bsi.bund.de/ecard/api/1.1/resultminor/ifdl/terminal#IFDSharingVolation"),
  /**
   * Fehler beim Zugriff auf das Kartenterminal Beim Zugriff auf das Kartenterminal ist ein Fehler aufgetreten. Die
   * Ursache kann ein Kommunikationsfehler oder ein Protokollfehler sein. URI value:
  ...
  /**
   * Kartenterminalslot existiert nicht Der in der Operation adressierte Slot des Kartenterminals existiert nicht.
   * (IFD_UNKNOWN_SLOT) Deprecated: This is not defined in TR-03112 URI value:
  ...
  /**
   * Keine eCard vorhanden Die eCard wurde manuell entfernt und ist durch das System nicht mehr erfassbar (IFD_NO_CARD)
   * Deprecated: This is not defined in TR-03112 URI value:
  ...
  /**
   * Kartenterminal unterstützt die gewünschte mechanische Funktionalität nicht Deprecated: This is not defined in
   * TR-03112 URI value: http://www.bsi.bund.de/ecard/api/1.1/resultminor/ifdl/terminal#mechanicalFunctionNotSupported
   */
  @Deprecated
