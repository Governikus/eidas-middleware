...
public class WriteAttributeRequestResult extends AbstractResult<Boolean> implements FunctionResult<Boolean>
{

  WriteAttributeRequestResult(Throwable throwable)
  {
    super(throwable);
  }

  WriteAttributeRequestResult(Boolean data)
  {
    super(data);
  }
}
