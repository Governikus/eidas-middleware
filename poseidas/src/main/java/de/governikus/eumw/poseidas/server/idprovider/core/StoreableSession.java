...
public interface StoreableSession extends Serializable
{
  ...
  /**
   * Returns the time in Milliseconds when this Session was created. This is needed to remove old sessions
   * form the store.
   */
  ...
  /**
   * The ID of the request used to create this Session. This must be unique over all managed entries. Will
   * return null if the session does not have a request ID.<br/>
