...
public class WriteAttributeResult extends AbstractResult<Boolean> implements FunctionResult<Boolean>
{

  WriteAttributeResult(Throwable throwable)
  {
    super(throwable);
  }

  WriteAttributeResult(Boolean data)
  {
    super(data);
  }
}
