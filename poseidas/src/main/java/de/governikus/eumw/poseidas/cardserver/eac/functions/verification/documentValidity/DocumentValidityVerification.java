...
package de.governikus.eumw.poseidas.cardserver.eac.functions.verification.documentValidity;
...
/**
 * Implementation of DocumentValidityVerification function.
 *
 * @see DocumentValidityVerificationParameter
 * @see ValidityVerificationResult
 * @author Jens Wothe, jw@bos-bremen.de
 * @author Arne Stahlbock, ast@bos-bremen.de
 */
public class DocumentValidityVerification extends AbstractValidityFunction<DocumentValidityVerificationParameter>
  implements FunctionStep<DocumentValidityVerificationParameter, ValidityVerificationResult>,
  TransmitCommandCreator<DocumentValidityVerificationParameter>
{
   ...
   */
  public DocumentValidityVerification(TransmitAPDU transmit)
  {
    super(transmit);
  }
  ...
  {
    // verify mit OID Document ID Verification - 03110 - A.6.5.3, S.64
    return new CommandAPDU(Hex.parse("802080000b" + "0609" + "04007f000703010402"));
  }
}
