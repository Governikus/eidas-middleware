 ...
 */
public class KeyHandlerEC extends de.governikus.eumw.poseidas.cardbase.crypto.key.KeyHandlerEC implements KeyHandler
{
  ...
  public byte[] calculateSharedSecret(PrivateKey priv, PublicKey pub)
  {
    ...
    return ByteUtil.trimByteArray(sharedPoint.normalize().getXCoord().toBigInteger().toByteArray(), super.fieldSize);
  }
}
