...
public interface CrlCache
{
   ...
   * In case the parameter <code>crl</code> is set to null, the entry for the given <code>url</code> will be deleted
   * from the cache.
   *
   * @param url key at which the specified crl is to be stored, or deleted in case the <code>crl</code> parameter is set
   *          to null
