...
public class HSMServiceFactoryImpl implements HSMServiceFactory
{
  ...
  /** {@inheritDoc} */
  @Override
  public HSMService getHSMService(int hsmType) throws HSMException
  {
    if (hsmType != HSMService.NO_HSM && hsmType != HSMService.UTIMACO_EID_HSM
        && hsmType != HSMService.THALES_HSM && hsmType != HSMService.UTIMACO_EID_HSM_CLUSTER)
    {
