...
#. If not present, copy the ``eidas-demo-2.1.3.jar`` file in this directory.
#. Start the application by executing ``java -jar eidas-demo-2.1.3.jar``.
...
To run the middleware, execute the following command after you have prepared the configuration, certificate and keystores::
    ...
    docker run --rm -it -v /path/to/your/config-directory:/opt/eidas-middleware/config -p 8080:8080 governikus/eidas-demo-application:2.1.3
