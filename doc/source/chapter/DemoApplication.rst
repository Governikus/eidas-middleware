...
#. If not present, copy the ``eidas-demo-1.2.10.jar`` file in this directory.
#. Start the application by executing ``java -jar eidas-demo-1.2.10.jar``.
...
To run the middleware, execute the following command after you have prepared the configuration, certificate and keystores::
    ...
    docker run --rm -it -v /path/to/your/config-directory:/opt/eidas-middleware/config -p 8080:8080 governikus/eidas-demo-application:1.2.10
