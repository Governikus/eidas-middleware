...
and the application will be available on port 8443. ::
    ...
    docker run --rm -it -v eidas-configuration:/opt/eidas-middleware/configuration -v eidas-database:/opt/eidas-middleware/database -p 8443:8443 --name eidas-middleware-application governikus/eidas-middleware-application:4.0.2
...
the following::
    ...
    docker run -d -v eidas-configuration:/opt/eidas-middleware/configuration -v eidas-database:/opt/eidas-middleware/database -p 8443:8443 --name eidas-middleware-application governikus/eidas-middleware-application:4.0.2
...
e.g. ``java -Xmx8g -jar eidas-middleware-4.0.2.jar`` for 8 GB.
...
``https://github.com/Governikus/eidas-middleware/blob/4.0.2/poseidas/snmp/EIDASMW-SNMP-MIB.mib``.
