...
public final class SPTypeHelper
{
   ...
   * insensitive. If the spTypeString does not equal private or public, a {@link IllegalArgumentException} is thrown.
   */
  public static SPTypeEnumeration getSPTypeFromString(String spTypeString)
  {
    ...
    {
      throw new IllegalArgumentException("Received Invalid SPType: " + StringEscapeUtils.escapeHtml4(spTypeString));
    }
  }
}
