...
@Repository
public interface RequestSessionRepository extends JpaRepository<RequestSession, String>
{

  Optional<RequestSession> findByEidRef(String eidRef);

  @Transactional
  long removeAllByCreationTimeBefore(Instant creationTime);
}
