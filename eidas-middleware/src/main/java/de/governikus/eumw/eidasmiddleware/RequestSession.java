...
public class RequestSession
{
  ...
  public RequestSession(String reqId, String reqDestination, String reqProviderName, String reqProviderEntityId)
  {
  ...
  {
    this(relayState, eidasRequest.getId(), eidasRequest.getDestination(), reqProviderName, eidasRequest.getIssuer());
    this.requestedAttributes.putAll(eidasRequest.getRequestedAttributes());
  }
