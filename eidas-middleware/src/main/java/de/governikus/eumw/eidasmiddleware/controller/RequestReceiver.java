...
public class RequestReceiver
{
                            ...
                            @RequestParam(required = false, name = "sessionId") String sessionId)
  {
    ...
    if (StringUtil.notNullOrEmpty(samlRequestBase64))
    {
      try
      {
        sessionId = requestHandler.handleSAMLRequest(relayState, samlRequestBase64, false);
      }
      ...
      return showMiddlewarePage(sessionId);
    }
   ...
   */
  private ModelAndView showMiddlewarePage(String sessionId)
  {
    try
    {

      String ausweisappLink = "http://127.0.0.1:24727/eID-Client?tcTokenURL=";
